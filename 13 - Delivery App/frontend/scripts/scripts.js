...
function checkingSearchInputValue() {
  ...
  if (InputValue[3]) {
    document.querySelector("#searchInputContainer").childNodes[3].style.cursor = "pointer"
  } else if (!InputValue[3]) {
    document.querySelector("#searchInputContainer").childNodes[3].style.cursor = "not-allowed"
  }
}
      ...
      <div id="card">
        ...
        <div id="productInfos">
          ...
          <div id="prices">
            ...
            <span>${"R$" + product.promotion.toFixed(2).replace(".", ",")}</span>
          </div>
        </div>
      </div>
    `
